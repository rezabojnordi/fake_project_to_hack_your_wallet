...
export default function Footer({ isDashboardRoute }) {
  ...
  return (
    ...
    //           <span className="text-2xl font-bold text-primary-600">SymptoHEXE</span>
    //         </Link>
    ...
    //       <p className="text-xs leading-5 text-gray-500">&copy; {new Date().getFullYear()} SymptoHEXE. All rights reserved.</p>
    //     </div>
    //   </div>
    // </footer>
    <></>
